...
total_wines = wine_data.shape[0]                            # gets the total number of wine samples in the dataset
correctly_classified = 173 + 2179                           # adds up the count of correctly classified wines based on the cross-tabulation table
accuracy = correctly_classified / total_wines               # calculates the accuracy by dividing correctly classified samples by the total number of samples
print(f"Clustering accuracy: {accuracy * 100:.2f}%")        # prints the clustering accuracy as a percentage with two decimal places
...
silhouette_avg = silhouette_score(wine_scaled, kmeans.labels_)
print("Silhouette Score:", silhouette_avg)

# visualizes clusters
plt.scatter(wine_scaled[:, 0], wine_scaled[:, 1], c=kmeans.labels_, cmap='viridis')
...
correctly_classified = 173 + 2179  # Wines in correct clusters
